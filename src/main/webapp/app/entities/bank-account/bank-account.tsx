  ...
  return (
    <div>
      <h2 id="bank-account-heading" data-cy="BankAccountHeading">
        <Translate contentKey="letsBankApp.bankAccount.home.title">Bank Accounts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="letsBankApp.bankAccount.home.refreshListLabel">
              Refresh List
            </Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="letsBankApp.bankAccount.home.createLabel">
        ...
        {bankAccountList && bankAccountList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="letsBankApp.bankAccount.createdDate">
                    Created Date
                  </Translate>{' '}
            ...
            <tbody>
              {bankAccountList.map((bankAccount, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{bankAccount.lastModifiedBy}</td>
                  <td>
                    {bankAccount.lastModifiedDate ? (
                      <TextFormat
                        type="date"
                        value={bankAccount.lastModifiedDate}
                        format={APP_DATE_FORMAT}
                      />
                    ) : null}
                  </td>
                  <td>
                    {bankAccount.person ? (
                      <Link to={`/bank-person/${bankAccount.person.id}`}>
                        {bankAccount.person.id}
                      </Link>
                    ) : (
                      ''
                    )}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="letsBankApp.bankAccount.home.notFound">
