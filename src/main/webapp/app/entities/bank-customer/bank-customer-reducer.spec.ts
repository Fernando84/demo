...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKCUSTOMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKCUSTOMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKCUSTOMER actions', async () => {
      const arg = { id: 'f449d19c-c670-4c80-8735-b61ee8fea9ff' };
    ...
    it('dispatches UPDATE_BANKCUSTOMER actions', async () => {
      const arg = { id: 'f449d19c-c670-4c80-8735-b61ee8fea9ff' };
    ...
    it('dispatches PARTIAL_UPDATE_BANKCUSTOMER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BANKCUSTOMER actions', async () => {
      const arg = 42666;
