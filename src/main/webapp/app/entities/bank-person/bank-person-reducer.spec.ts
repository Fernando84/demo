...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKPERSON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKPERSON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKPERSON actions', async () => {
      const arg = { id: '387adde2-7c25-42f4-a44e-22491f7f9d7f' };
    ...
    it('dispatches UPDATE_BANKPERSON actions', async () => {
      const arg = { id: '387adde2-7c25-42f4-a44e-22491f7f9d7f' };
    ...
    it('dispatches PARTIAL_UPDATE_BANKPERSON actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BANKPERSON actions', async () => {
      const arg = 42666;
