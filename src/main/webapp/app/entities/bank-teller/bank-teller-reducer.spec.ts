...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTELLER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKTELLER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKTELLER actions', async () => {
      const arg = { id: '8f73efc7-b126-451c-b3c1-e64df829c487' };
    ...
    it('dispatches UPDATE_BANKTELLER actions', async () => {
      const arg = { id: '8f73efc7-b126-451c-b3c1-e64df829c487' };
    ...
    it('dispatches PARTIAL_UPDATE_BANKTELLER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BANKTELLER actions', async () => {
      const arg = 42666;
