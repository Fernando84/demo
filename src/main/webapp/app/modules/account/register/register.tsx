...
export const RegisterPage = () => {
  ...
  const handleValidSubmit = ({ username, email, firstPassword, thaiName, pinCode, personalId }) => {
    dispatch(
      handleRegister({
        login: username,
        email,
      ...
      <Row className="justify-content-center">
        <Col md="8">
          <ValidatedForm id="register-form" onSubmit={handleValidSubmit}>
            ...
            <ValidatedField
              name="thaiName"
              label={translate('global.form.thainame.label')}
              placeholder={translate('global.form.thainame.placeholder')}
              validate={{
                minLength: {
                  value: 1,
                  message: translate('register.messages.validate.login.minlength'),
            ...
            <ValidatedField
              name="pinCode"
              maxLength={6}
              label={translate('global.form.pincode.label')}
              placeholder={translate('global.form.pincode.placeholder')}
              validate={{
                minLength: {
                  value: 6,
                  message: translate('register.messages.validate.login.pincodelength'),
                },
                maxLength: {
                  value: 6,
                  message: translate('register.messages.validate.login.pincodelength'),
            ...
            <ValidatedField
              name="personalId"
              maxLength={13}
              label={translate('global.form.personalId.label')}
              placeholder={translate('global.form.personalId.placeholder')}
              validate={{
                minLength: {
                  value: 13,
                  message: translate('register.messages.validate.login.personalIdlength'),
                },
                maxLength: {
                  value: 13,
                  message: translate('register.messages.validate.login.personalIdlength'),
